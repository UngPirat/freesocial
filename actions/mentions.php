 ...
 * @link     http://status.net/
 */
class MentionsAction extends Action
{
    var $page = null;
    var $notice;
     ...
     * Show the content
     *
     * A list of notices that are mentions of the user, plus pagination.
     *
     * @return void
     */
    ...
    {
        // TRANS: Empty list message for page with mentions of a user.
        // TRANS: %1$s and %s$s are the user nickname.
        $message = sprintf(_('This is the timeline showing mentions of %1$s but %2$s hasn\'t received a notice to them yet.'),
                           $this->user->nickname,
                           $this->user->nickname) . ' ';
        ...
        if (common_logged_in()) {
            ...
            if ($this->user->id === $current_user->id) {
                // TRANS: Empty list message for page with mentions of a user for the logged in user.
                // TRANS: This message contains a Markdown link in the form [link text](link).
                $message .= _('You can engage other users in a conversation, subscribe to more people or [join groups](%%action.groups%%).');
            } else {
                // TRANS: Empty list message for page with mentions of a user for all logged in users but the user themselves.
            ...
            // TRANS: Empty list message for page with mentions of a user for not logged in users.
